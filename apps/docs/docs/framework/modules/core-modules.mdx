...
| Module | ID | Description |
|---|---|---|
| **Automation** | `workflows` | Orchestrate business processes with state machines, transitions, and activities. |
...
| **Resources** | `resources` | Assets and resources with scheduling policies. |
