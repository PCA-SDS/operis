...
function RoleTile({
  ...
  return (
    <div className="rounded-xl border border-transparent bg-surface shadow-sm p-6 flex flex-col gap-4 transition-all hover:shadow-md">
  ...
  return (
    <>
      <section className="rounded-lg border bg-gradient-to-br from-background to-muted/20 p-8 text-center">
        <h2 className="text-2xl font-semibold mb-3">{t('startPage.welcome.title', 'Welcome to Your Operis Installation')}</h2>
        <p className="text-muted-foreground max-w-2xl mx-auto">
          {t('startPage.welcome.description', 'This is a customizable start page for your fresh Operis installation. Choose your role below to get started and explore the features available to you.')}
        </p>
      </section>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="text-sm text-status-success-text/90">
                  {t('startPage.onboarding.description', 'Create a tenant, organization, and administrator account in minutes. We\'ll verify your email and deliver a pre-seeded environment so you can explore Operis with real data.')}
                </p>
              </div>
      ...
      <section className="rounded-xl border border-transparent bg-surface shadow-sm p-6 space-y-4">
