  ...
  return (
    <main className="min-h-svh w-full p-8 flex flex-col gap-8">
      <header className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
        <Image
          src="/operis.svg"
          alt={t('app.page.logoAlt', 'Operis')}
          width={40}
          height={40}
          priority
        />
        <div className="flex-1">
          <h1 className="text-3xl font-semibold tracking-tight">{t('app.page.title', 'Operis')}</h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="rounded-xl border border-transparent bg-surface shadow-sm p-4 md:col-span-2">
