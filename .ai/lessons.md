...
- [Client UI must gate on the viewer's reachable module set, never on a hardcoded route](lessons/client-ui-must-gate-on-the-viewers-reachable-module.md) — area:backend-ui,architecture; module:platform,directory,auth; topic:access-control,ui-components,module-boundaries
