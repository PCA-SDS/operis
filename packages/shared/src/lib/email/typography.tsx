 ...
 *
 * The product UI is set in SF Pro on Apple devices and Inter elsewhere (self-hosted, see `apps/mercato/src/app/fonts.css`).
...
export const EMAIL_FONT_FAMILY =
  "-apple-system, BlinkMacSystemFont, Inter, 'Segoe UI', Roboto, 'Helvetica Neue', Helvetica, Arial, sans-serif"
...
/**
 * Drop inside `<Head>` so clients that support webfonts pull Inter.
