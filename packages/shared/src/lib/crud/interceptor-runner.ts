 ...
 * for the full timeout window on every intercepted request — under load that is
 * requests-per-second x active interceptors of live timers inflating the timer
