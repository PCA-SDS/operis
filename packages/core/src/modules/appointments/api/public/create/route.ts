...
const logger = createLogger('appointments').child({ component: 'public-intake' })
 ...
 * route in the repo (`customers/people/check`, `sales/quotes/accept`).
 */
const publicIntakeRateLimitConfig = readEndpointRateLimitConfig('APPOINTMENTS_PUBLIC_CREATE', {
  points: 10,
  duration: 60,
  blockDuration: 300,
  keyPrefix: 'appointments_public_create',
})
