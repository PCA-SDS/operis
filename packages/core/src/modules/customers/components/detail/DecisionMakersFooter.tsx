...
export function DecisionMakersFooter({ names, suggestion, onSendInvitation }: DecisionMakersFooterProps) {
  ...
  return (
    <div className="sticky bottom-0 flex flex-col gap-3 rounded-xl border border-transparent bg-surface shadow-sm px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
