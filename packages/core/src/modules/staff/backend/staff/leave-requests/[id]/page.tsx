...
const handleSubmit = React.useCallback(async (values: LeaveRequestFormValues) => {
  ...
  return (
    <Page>
      <PageBody>
        <div className="mb-6 space-y-2 rounded-xl border border-transparent bg-surface shadow-sm p-4">
        ...
        {status === 'pending' ? (
          <div className="mb-6 rounded-xl border border-transparent bg-surface shadow-sm p-4">
          ...
          <div className="mb-6 rounded-xl border border-transparent bg-surface shadow-sm p-4 text-sm text-muted-foreground">
