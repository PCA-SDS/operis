...
const events = [
  ...
  { id: 'staff.employee_profile.created', label: 'HR Profile Created', entity: 'employee_profile', category: 'crud' },
  { id: 'staff.employee_profile.updated', label: 'HR Profile Updated', entity: 'employee_profile', category: 'crud' },
  { id: 'staff.employee_profile.deleted', label: 'HR Profile Deleted', entity: 'employee_profile', category: 'crud' },
