...
function LocationKpiCard({
  ...
  return (
    <section className="flex min-h-52 flex-col rounded-xl border border-transparent bg-surface shadow-sm p-5 text-card-foreground">
      <div>
      ...
      <PageBody className="space-y-6">
        ...
        {!isLoading && !hasError && locationQuery.data ? (
          <>
            ...
            <section
              id="location-items"
              className="rounded-xl border border-transparent bg-surface shadow-sm text-card-foreground"
            >
            ...
            <section className="flex flex-col gap-4 rounded-xl border border-transparent bg-surface shadow-sm px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <h2 className="text-base font-semibold">
