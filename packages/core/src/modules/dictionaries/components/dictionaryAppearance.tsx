...
const EXTRA_LUCIDE_ICON_LIBRARY: Array<{ slug: string; label: string; keywords?: string[] }> = [
  ...
  { slug: 'car', label: 'Car', keywords: ['vehicle', 'transport'] },
  ...
  { slug: 'door-closed', label: 'Door', keywords: ['room'] },
  ...
  { slug: 'layout-grid', label: 'Grid', keywords: ['section', 'layout'] },
  { slug: 'link', label: 'Link', keywords: ['url'] },
  { slug: 'lock', label: 'Lock', keywords: ['security'] },
  { slug: 'map', label: 'Map', keywords: ['campus', 'location'] },
  ...
  { slug: 'video', label: 'Video', keywords: ['camera', 'meeting'] },
