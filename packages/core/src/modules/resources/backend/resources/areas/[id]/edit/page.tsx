    ...
    <Page>
      <PageBody>
        ...
        <ResourceAreaCrudForm
          mode="edit"
          initialValues={initialValues ?? { id: resourceAreaId, name: '', description: '', appearance: { icon: null, color: null }, areaType: 'other', parentAreaId: null, sortOrder: 0, isActive: true }}
          isLoading={loading}
