...
const SELECT_CLASS_NAME = 'flex h-9 w-full rounded-md border border-input bg-input-bg px-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50'
