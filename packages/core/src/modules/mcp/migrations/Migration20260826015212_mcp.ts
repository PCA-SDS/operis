...
export class Migration20260826015212_mcp extends Migration {
  ...
  override up(): void | Promise<void> {
    ...
    this.addSql(`alter table "catalog_product_constraints" drop constraint if exists "catalog_product_constraints_source_variant_id_foreign";`);
    this.addSql(`alter table "catalog_product_constraints" drop constraint if exists "catalog_product_constraints_target_variant_id_foreign";`);
  ...
  override down(): void | Promise<void> {
    ...
    this.addSql(`create table "catalog_product_constraints" ("id" uuid not null default gen_random_uuid(), "organization_id" uuid not null, "tenant_id" uuid not null, "source_variant_id" uuid not null, "target_variant_id" uuid not null, "constraint_type" text not null, "metadata" jsonb null, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) not null, primary key ("id"));`);
    this.addSql(`create index "catalog_product_constraints_source_idx" on "catalog_product_constraints" ("source_variant_id", "organization_id", "tenant_id");`);
    this.addSql(`create index "catalog_product_constraints_target_idx" on "catalog_product_constraints" ("target_variant_id", "organization_id", "tenant_id");`);
    ...
    this.addSql(`create table "tenant_modules" ("id" uuid not null default gen_random_uuid(), "tenant_id" uuid not null, "module_id" text not null, "is_enabled" bool not null default true, "created_at" timestamptz(6) not null, "updated_at" timestamptz(6) null, "deleted_at" timestamptz(6) null, "starts_at" timestamptz(6) null, "ends_at" timestamptz(6) null, "ai_assistant_enabled" bool not null default false, primary key ("id"));`);
    ...
    this.addSql(`alter table "catalog_product_constraints" add constraint "catalog_product_constraints_source_variant_id_foreign" foreign key ("source_variant_id") references "catalog_product_variants" ("id") on update no action on delete cascade;`);
    this.addSql(`alter table "catalog_product_constraints" add constraint "catalog_product_constraints_target_variant_id_foreign" foreign key ("target_variant_id") references "catalog_product_variants" ("id") on update no action on delete cascade;`);
