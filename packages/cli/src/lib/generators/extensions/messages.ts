    ...
    generateOutput() {
      ...
      const messagesClientOutput = renderGeneratedTsSource({
        ...
        imports: [
          ...
          { namedImports: ['registerMessageObjectTypes'], moduleSpecifier: '@open-mercato/core/internal/modules/messages/lib/message-objects-registry' },
          { namedImports: ['configureMessageUiComponentRegistry'], moduleSpecifier: '@open-mercato/core/internal/modules/messages/components/utils/typeUiRegistry' },
          ...messageTypeImports,
          ...messageObjectTypeImports,
        ],
        build(sourceFile) {
