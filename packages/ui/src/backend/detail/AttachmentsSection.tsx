          ...
          {items.map((item) => {
            return (
              <div
                key={item.id}
                role="group"
                className="group relative flex flex-col overflow-hidden rounded-xl border border-transparent bg-surface shadow-sm text-left transition-shadow hover:shadow-sm focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2"
              >
                <Button
                  type="button"
                  variant="ghost"
