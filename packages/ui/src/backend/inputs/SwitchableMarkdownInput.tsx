...
export function SwitchableMarkdownInput({
  ...
  const textareaClasses =
    textareaClassName
    ?? 'w-full resize-none overflow-hidden rounded-lg border border-muted-foreground/20 bg-input-bg px-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring'
