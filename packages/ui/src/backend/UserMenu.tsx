    ...
    <div className="relative" onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave}>
      ...
      {open && (
        <div
          ...
          className="absolute right-0 top-full mt-0 flex w-56 flex-col gap-1 rounded-md border bg-surface p-1 shadow z-dropdown"
          role="menu"
        ...
        >
          ...
          <Link
            ...
            className="w-full text-left text-sm px-2 py-1 rounded-md hover:bg-accent inline-flex items-center gap-2 outline-none focus-visible:outline-none focus-visible:outline-none ring-0 focus-visible:ring-0 focus-visible:ring-0"
            role="menuitem"
            tabIndex={0}
