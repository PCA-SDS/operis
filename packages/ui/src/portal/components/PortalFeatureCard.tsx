...
export function PortalFeatureCard({ icon, title, description, href, onClick }: PortalFeatureCardProps) {
  ...
  const cls = 'flex flex-col rounded-xl border border-transparent bg-surface shadow-sm p-5 transition-colors hover:bg-accent/50'
  ...
  return <div className="flex flex-col rounded-xl border border-transparent bg-surface shadow-sm p-5">{content}</div>
}
