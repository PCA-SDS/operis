  ...
  return (
    <Page>
      <PageBody>
        ...
        {testDelivery ? (
          <div className="mt-8 rounded-xl border border-transparent bg-surface shadow-sm p-4">
        ...
        {selectedDelivery || selectedDeliveryLoading ? (
          <div className="mt-6 rounded-xl border border-transparent bg-surface shadow-sm p-4">
