    ...
    <div className="p-3 space-y-3">
      ...
      <div className="space-y-3">
        ...
        {pendingQuestion && pendingQuestion.questions[0] && (
          <div className="p-4 bg-status-warning-solid/10 border border-status-warning-icon/30 rounded-lg space-y-3">
            <div className="flex items-center gap-2 text-status-warning-icon dark:text-status-warning-icon text-sm font-medium">
